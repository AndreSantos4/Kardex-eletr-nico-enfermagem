    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity)
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/auth/verify")
                        .permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/workers/medics")
                        ...
                        .hasAnyRole("ENFERMEIRO", "ENFERMEIRO_CHEFE")
                        .requestMatchers(HttpMethod.PUT, "/api/patients/patientId")
                        .hasAnyRole("ENFERMEIRO", "ENFERMEIRO_CHEFE")
                        .requestMatchers(
                                HttpMethod.GET,
                                "/api/patients",
                                "/api/patients/patiendId")
                        .hasAnyRole("ENFERMEIRO", "ENFERMEIRO_CHEFE", "MEDICO")
                        .requestMatchers(
                                HttpMethod.PATCH,
                                "/api/processes/processId/discharge")
                        .hasAnyRole("MEDICO")
                        .requestMatchers(
                                HttpMethod.POST,
                                "/api/processes/processId/vitals")
                        .hasAnyRole("ENFERMEIRO", "ENFERMEIRO_CHEFE")
                        .requestMatchers(HttpMethod.GET, "/api/sessions")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/api/processes/processId/prescriptions")
                        .hasAnyRole("MEDICO", "ENFERMEIRO_CHEFE", "ENFERMEIRO")
                        .requestMatchers(HttpMethod.POST, "/api/processes/prescription/prescriptionId/administrations")
                        ...
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.DELETE, "/api/sessions/ip")
                        .hasRole("ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/sessions/ip")
                        .hasRole("ADMIN")
                        ...
                        .requestMatchers(
                                ...
                                "/recuperarPassword",
                                "/pages/login/recuperarPassword.html")
                        .permitAll()
                        .requestMatchers(
                                "/adminDashboard",
