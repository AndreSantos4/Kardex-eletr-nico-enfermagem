...
function gerarRelatorio() {
     ...
     *   Body: payload
     *   - KPIs:                  GET  /api/admin/relatorios/kpis?inicio=...&fim=...
     *   - Top medicamentos:      GET  /api/admin/relatorios/top-medicamentos?...
     *   - Atividade profissional:GET  /api/admin/relatorios/atividade?...
     *   - Estatísticas clínicas: GET  /api/admin/relatorios/estatisticas?...
     *   - Consumo material:      GET  /api/admin/relatorios/material?...
     */
}
